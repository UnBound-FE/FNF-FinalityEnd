...
class DialogueCharacterEditorState extends MusicBeatState
{
  ...
  function reloadCharacter()
  {
    ...
    DiscordClient.instance.changePresence({details: "Dialogue Character Editor", state: "Editting: " + character.jsonFile.image});
    #end
  }
  ...
  function onLoadComplete(_):Void
  {
    ...
    if (fullPath != null)
    {
      ...
      if (rawJson != null)
      {
        var loadedChar:DialogueCharacterFile = tjson.TJSON.parse(rawJson);
