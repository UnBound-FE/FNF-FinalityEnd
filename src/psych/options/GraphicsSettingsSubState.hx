...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
  ...
  public function new()
  {
    ...
    boyfriend = new Character(750, 140, 'bffreak', true);
  ...
  function onChangeMenuFuck()
  {
    @:privateAccess {
      if (OptionsState.vcrEffect != null)
      {
        if (ClientPrefs.data.shaders) FlxG.camera.setFilters([new ShaderFilter(OptionsState.vcrEffect.shader)]);
        else
          FlxG.camera.setFilters([]); // destroy fuck
      }
    }
  }
