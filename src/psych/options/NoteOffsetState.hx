...
import psych.states.stages.StageWeek1 as BackgroundStage;
...
class NoteOffsetState extends MusicBeatState
{
  ...
  {
    #if DISCORD_ALLOWED
    DiscordClient.instance.changePresence({details: "Delay/Combo Offset Menu"});
    #end
    ...
    timeTxt.setFormat(Paths.font("HelpMe.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    ...
    changeModeText.setFormat(Paths.font("HelpMe.ttf"), 32, FlxColor.WHITE, CENTER);
  ...
  override public function update(elapsed:Float)
  {
    ...
    if (controls.BACK)
    {
      ...
      MusicBeatState.switchState(new psych.options.OptionsState());
  ...
  function createTexts()
  {
    for (i in 0...4)
    {
      ...
      text.setFormat(Paths.font("HelpMe.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
