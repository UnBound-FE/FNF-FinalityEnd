...
class BaseOptionsMenu extends MusicBeatSubstate
{
  ...
  public function new()
  {
    ...
    #if DISCORD_ALLOWED
    DiscordClient.instance.changePresence({details: rpcTitle});
    #end

    bg = new FlxSprite().loadGraphic(Paths.image('bgnew'));
    bg.color = 0xF04B0298;
    bg.screenCenter();
    ...
    descText.setFormat(Paths.font("HelpMe.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
  ...
  function changeSelection(change:Int = 0)
  {
    ...
    else if (curSelected >= optionsArray.length) curSelected = 0;
