...
class VcrGlitchEffect
{
  ...
  public function update(elapsed:Float)
  {
    ...
    shader.iTime.value[0] = (theTime / 2);
  }
}
...
void main() {
    float fuzzOffset = snoise(vec2(iTime*15.0,openfl_TextureCoordv.y*80.0))*0.0005;
float largeFuzzOffset = snoise(vec2(iTime*1.0,openfl_TextureCoordv.y*25.0))*0.001;
